...
import com.lia.lego.model.RawInventory;
...
public class RawInventoryRepositoryImp implements RawInventoryRepository{
   ...
   public void delete(CommonObject obj) {
      RawInventory inventory = (RawInventory) obj;
   ...
   public CommonObject retrieveAccordingKey(UUID key) {
      ...
      List<RawInventory> inventoryList = query.list();
   ...
   public List<CommonObject> retrieve() {
      ...
      List<RawInventory> inventoryList = query.list();
      for (RawInventory inventory : inventoryList) {
